...
{
    /** @param array<string,list<string>> $references @param list<array{label:string,value:string,period?:string,from?:string,until?:string}> $details @param array<string,ExternalPerson> $people @param list<ExternalPersonRelation> $owners @param list<ExternalPersonRelation> $occupants @param array<string,int|float> $population @param list<list<array{label:string,value:string,url:string}>> $hierarchies @param list<string> $typeIds @param list<ExternalAddress> $addresses */
